...
extern "C"
{
  ...
  extern uint8_t tests_archive_start[] asm("_binary_resources_tests_tar_gz_start");
  extern uint8_t tests_archive_end[] asm("_binary_resources_tests_tar_gz_end");
...
extern "C"
{
  ...
  {
    uint64_t size = tests_archive_end - tests_archive_start;
  ...
  void SKIP_sknpm_save_archive(char *skTarget)
  {
    ...
    fwrite((char *)tests_archive_start, size, 1, write_ptr);
    fclose(write_ptr);
